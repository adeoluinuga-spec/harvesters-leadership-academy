...
- Course and lesson video playback; YouTube URLs are preferred, with Vimeo and direct video links still supported.
...
| YouTube/Vimeo | Course and lesson video playback when hosted video links are used | video URLs; no dedicated environment variable currently found |
